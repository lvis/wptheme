...
$contentCartEmpty = "{$actionCartBefore}<div class='text-xs-center'><h1 class='far fa-shopping-cart fa-5x'></h1>
...
if (wc_get_page_id('shop') > 0) {
    ...
    <a class='button wc-backward' href='{$linkReturnToShop}'><i class='far fa-store'></i> {$textReturnToShop}</a></p>";
}
